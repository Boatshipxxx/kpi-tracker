...
1. 新記事を1本執筆（実在の学術エビデンス付き）。当面は**大学広報向けショート連載**（n14〜。大学の広報担当者・学長向け、Smart Brevity準拠のショート形式、実績として城西大学 [TEAM JOSAI!](https://www.josai.ac.jp/tjp/) を毎回リンク、「メディアを作ってアプローチする」文脈に接続）を優先。切り口が尽きたらインナーブランディング / 広報企画のうち本数が少ないテーマで執筆
