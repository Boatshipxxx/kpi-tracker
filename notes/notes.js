...
<p>BOATshipでは、インナーブランディングをスローガンではなく「制度と体験」から設計します。等価交換報酬制度がわかりやすい例です。お金以外の価値で対価を交換するこの仕組みは、メンバーやパートナーに「この取引に自分は納得しているか」を毎回問いかけます。判断の主語が組織ではなく個人に戻るため、必然的に当事者性が育つ。制度が価値観を体現していれば、行動は号令なしに揃っていきます。制度・行動・言葉——この三つが一致したとき、理念は初めて文化になります。</p>
<h2>設計のチェックリスト</h2>
