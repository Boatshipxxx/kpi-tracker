...
<p>The origin was discomfort with a sentence we kept hearing: "we don't have the budget, so we can't ask you." The potential and the passion behind the project were real; it seemed wasteful to be unable to work together purely for lack of money. The fuller account is published on our owned media as <a href="/en/magazine/equal-exchange-compensation/">Why We Accept Vegetables as Payment</a>.</p>
...
<p>Tracing my roots leads back to a family that built marine equipment here in Tokyo. That is the origin of the name BOATship.</p>
<p>What we make has changed, but the spirit has carried over: to build the tools that move someone forward.</p>
<p>As an integrated editorial partner for companies, we handle media content and brand communications — uncovering the originality that already lives inside an organization, and turning it into communication with impact.</p>
<p>Shinya Kosaka, CEO</p>
